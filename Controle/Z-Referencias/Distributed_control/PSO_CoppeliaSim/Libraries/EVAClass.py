    ...
    def EVA_0(self, x, kpi, kii, kdi, deltaT):
        ...
        if (sim.simxGetConnectionId(clientID_EVA_0) != -1):
            ...
            while (a == 1):
                ...
                print(f'vl ==  {vl}, vd == {vd}, omega == {omega}, errorphi == {error_phi}')
...
if __name__ == "__main__":
    ...
    # yideal = [2]
    # xideal = [2]
    # Coordenadas del cuadrado 1
    object_x1 = [2, 3, 3, 2, 2]
    object_y1 = [2, 2, 3, 3, 2]

    # Coordenadas del cuadrado 2
    object_x2 = [4, 5, 5, 4, 4]
    object_y2 = [1, 1, 4, 4, 1]
    ...
    square_value_x = [[2, 3], [4, 5], [5.5, 6], [0.5, 6], [0, 0.5], [0, 5.5]]
    square_value_y = [[2, 3], [1, 4], [0, 5.5], [5, 5.5], [0, 5.5], [0, 0.5]]
    ...
    for i in range(len(x_end)):
        ...
        Bioinspired_object_path = Bioinspired.Bioinspired()
        x0 = [x_init[i]]
        y0 = [y_init[i]]
        xend = x_end[i]
        yend = y_end[i]
        ...
        x_bio, y_bio =Bioinspired_object_path.PSO(x0, y0, xend, yend, square_value_x, square_value_y)
        x_mean, y_mean = Bioinspired_object_path.Mean(x_bio, y_bio, Point_numbers)
        xideal = [round(numero_x, 4) for numero_x in x_mean]
        yideal = [round(numero_y, 4) for numero_y in y_mean]
        ...
        plt.plot(xideal, yideal, color='green')
        plt.grid(True)
        plt.show()
