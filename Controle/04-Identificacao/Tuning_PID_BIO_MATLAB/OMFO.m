...
function [Best_flame_score,Best_flame_pos]=MFO(N,Max_iteration,lb,ub,dim,sp)
...
while Iteration<Max_iteration+1
    ...
    for i=1:size(Moth_pos,1)
        ...
        if (Best_flame_score < f_impr)
            f_impr = Best_flame_score;
            FNC=0;
            opposite=0;
        elseif FNC == maxFNC
            f_impr = 1e10;
        ...
        for j=1:size(Moth_pos,2)
            if i<=Flame_no % Update the position of the moth with respect to its corresponsing flame
                ...
                if opposite==0
                    ...
                    mchg=rand();
                    if rand()>0.5 
                        Moth_pos(i,j) = -Moth_pos(i,j)+ mchg/10;
                    end
                end
            end
